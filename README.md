...
### Testing
This project contains one sample code that contains mutual recursion procedures. Thus, its call-graph contains cycles; a test has been made to make that assertion. To test it, add JUnit to your project, and right-click then select Run As > JUnit Test.
